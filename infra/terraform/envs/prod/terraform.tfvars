...
spa_bucket_name = "wm-prod-spa-PLACEHOLDER"

spa_domain_aliases      = []  # e.g. ["app.work-manager.molcube.com"]
...
route53_zone_name = ""        # e.g. "work-manager.molcube.com"
api_record_name   = ""        # e.g. "api.work-manager.molcube.com"
