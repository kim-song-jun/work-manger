/**
 * Story: pages/signup · SignupPage
 * Type: Visual (Storybook + msw)
 * Why:  Renders the signup page in isolation so visual regressions can be
...
import { SignupPage as Page } from "./index";
const meta: Meta<typeof Page> = {
  title: "Pages/Auth/signup",
  component: Page,
  parameters: { layout: "fullscreen" },
  decorators: [withPageProviders(["/signup"])],
};
export default meta;
