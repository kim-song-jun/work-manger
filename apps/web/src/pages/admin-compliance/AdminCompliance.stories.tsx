/**
 * Story: pages/admin-compliance · AdminCompliancePage
 * Type: Visual (Storybook + msw)
 * Why:  Renders the admin-compliance page in isolation so visual regressions can be
...
import { AdminCompliancePage as Page } from "./index";
const meta: Meta<typeof Page> = {
  title: "Pages/Admin/admin-compliance",
  component: Page,
  parameters: { layout: "fullscreen" },
  decorators: [withPageProviders(["/admin/compliance"])],
};
export default meta;
