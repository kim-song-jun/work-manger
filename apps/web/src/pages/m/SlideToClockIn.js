...
export function SlideToClockIn({ onCommit, disabled, labelIn, labelOut, active }) {
    ...
    return (_jsxs("div", { ref: trackRef, role: "slider", "aria-label": active ? labelOut : labelIn, "aria-valuemin": 0, "aria-valuemax": 100, "aria-valuenow": Math.round(pct * 100), "aria-disabled": disabled || committing, style: {
            height: 64,
            borderRadius: 32,
            ...
            touchAction: "none",
                    ...
                    fontSize: 14,
                    pointerEvents: "none",
                }, children: (active ? labelOut : labelIn) + "  →" }), _jsx("div", { onPointerDown: onDown, style: {
                    position: "absolute",
                    top: 4,
                ...
                }, children: _jsx(Icon.chevR, { width: 24, height: 24 }) })] }));
}
