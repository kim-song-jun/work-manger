...
type Brand = "blue" | "mint" | "violet" | "coral";
type FontSize = "sm" | "md" | "lg";

const STORAGE_KEY = "wm:tweaks";

type Tweaks = { theme: Theme; brand: Brand; fontSize: FontSize; lang: "ko" | "en" };

const defaults: Tweaks = { theme: "light", brand: "blue", fontSize: "md", lang: "ko" };
...
function applyTweaks(tw: Tweaks) {
