/**
 * Story: pages/web-records · WebRecordsPage
 * Type: Visual (Storybook + msw)
 * Why:  Renders the web-records page in isolation so visual regressions can be
...
import { WebRecordsPage as Page } from "./index";
const meta: Meta<typeof Page> = {
  title: "Pages/Web/records",
  component: Page,
  parameters: { layout: "fullscreen" },
  decorators: [withPageProviders(["/web/records"])],
};
export default meta;
