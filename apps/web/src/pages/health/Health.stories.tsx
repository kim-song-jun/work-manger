/**
 * Story: pages/health · HealthPage
 * Type: Visual (Storybook + msw)
 * Why:  Renders the health page in isolation so visual regressions can be
...
import { HealthPage as Page } from "./index";
const meta: Meta<typeof Page> = {
  title: "Pages/Auth/health",
  component: Page,
  parameters: { layout: "fullscreen" },
  decorators: [withPageProviders(["/health"])],
};
export default meta;
