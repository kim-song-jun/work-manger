/**
 * Story: pages/m-record-detail · RecordDetailPage
 * Type: Visual (Storybook + msw)
 * Why:  Renders the m-record-detail page in isolation so visual regressions can be
...
import { RecordDetailPage as Page } from "./index";
const meta: Meta<typeof Page> = {
  title: "Pages/Mobile/record-detail",
  component: Page,
  parameters: { layout: "fullscreen" },
  decorators: [withPageProviders(["/record-detail"])],
};
export default meta;
