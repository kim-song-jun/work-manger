/**
 * Story: pages/m-error-gps · ErrorGpsPage
 * Type: Visual (Storybook + msw)
 * Why:  Renders the m-error-gps page in isolation so visual regressions can be
...
import { ErrorGpsPage as Page } from "./index";
const meta: Meta<typeof Page> = {
  title: "Pages/Mobile/error-gps",
  component: Page,
  parameters: { layout: "fullscreen" },
  decorators: [withPageProviders(["/error-gps"])],
};
export default meta;
