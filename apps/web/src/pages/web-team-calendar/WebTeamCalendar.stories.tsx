/**
 * Story: pages/web-team-calendar · WebTeamCalendarPage
 * Type: Visual (Storybook + msw)
 * Why:  Renders the web-team-calendar page in isolation so visual regressions can be
...
import { WebTeamCalendarPage as Page } from "./index";
const meta: Meta<typeof Page> = {
  title: "Pages/Web/team-calendar",
  component: Page,
  parameters: { layout: "fullscreen" },
  decorators: [withPageProviders(["/web/team-calendar"])],
};
export default meta;
