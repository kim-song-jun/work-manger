/**
 * Story: pages/m-compliance-block · ComplianceBlockPage
 * Type: Visual (Storybook + msw)
 * Why:  Renders the m-compliance-block page in isolation so visual regressions can be
...
const meta: Meta<typeof Page> = {
  ...
  decorators: [withPageProviders(["/compliance-block"])],
};
export default meta;
