/**
 * Story: pages/m-leave · LeavePage
 * Type: Visual (Storybook + msw)
 * Why:  Renders the m-leave page in isolation so visual regressions can be
...
import { LeavePage as Page } from "./index";
const meta: Meta<typeof Page> = {
  title: "Pages/Mobile/leave",
  component: Page,
  parameters: { layout: "fullscreen" },
  decorators: [withPageProviders(["/leave"])],
};
export default meta;
