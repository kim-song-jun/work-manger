/**
 * Story: pages/admin-reports · AdminReportsPage
 * Type: Visual (Storybook + msw)
 * Why:  Renders the admin-reports page in isolation so visual regressions can be
...
import { AdminReportsPage as Page } from "./index";
const meta: Meta<typeof Page> = {
  title: "Pages/Admin/admin-reports",
  component: Page,
  parameters: { layout: "fullscreen" },
  decorators: [withPageProviders(["/admin/reports"])],
};
export default meta;
