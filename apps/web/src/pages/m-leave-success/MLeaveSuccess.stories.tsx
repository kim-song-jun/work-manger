/**
 * Story: pages/m-leave-success · LeaveSuccessPage
 * Type: Visual (Storybook + msw)
 * Why:  Renders the m-leave-success page in isolation so visual regressions can be
...
import { LeaveSuccessPage as Page } from "./index";
const meta: Meta<typeof Page> = {
  title: "Pages/Mobile/leave-success",
  component: Page,
  parameters: { layout: "fullscreen" },
  decorators: [withPageProviders(["/leave-success"])],
};
export default meta;
