/**
 * Story: pages/admin-codes · AdminCodesPage
 * Type: Visual (Storybook + msw)
 * Why:  Renders the admin-codes page in isolation so visual regressions can be
...
import { AdminCodesPage as Page } from "./index";
const meta: Meta<typeof Page> = {
  title: "Pages/Admin/admin-codes",
  component: Page,
  parameters: { layout: "fullscreen" },
  decorators: [withPageProviders(["/admin/codes"])],
};
export default meta;
