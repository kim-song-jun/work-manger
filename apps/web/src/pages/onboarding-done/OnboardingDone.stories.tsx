/**
 * Story: pages/onboarding-done · DonePage
 * Type: Visual (Storybook + msw)
 * Why:  Renders the onboarding-done page in isolation so visual regressions can be
...
import { DonePage as Page } from "./index";
const meta: Meta<typeof Page> = {
  title: "Pages/Onboarding/done",
  component: Page,
  parameters: { layout: "fullscreen" },
  decorators: [withPageProviders(["/onboarding/done"])],
};
export default meta;
