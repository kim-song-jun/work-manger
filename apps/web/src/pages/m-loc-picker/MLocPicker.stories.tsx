/**
 * Story: pages/m-loc-picker · LocPickerPage
 * Type: Visual (Storybook + msw)
 * Why:  Renders the m-loc-picker page in isolation so visual regressions can be
...
import { LocPickerPage as Page } from "./index";
const meta: Meta<typeof Page> = {
  title: "Pages/Mobile/loc-picker",
  component: Page,
  parameters: { layout: "fullscreen" },
  decorators: [withPageProviders(["/loc-picker"])],
};
export default meta;
