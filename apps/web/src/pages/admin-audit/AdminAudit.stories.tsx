/**
 * Story: pages/admin-audit · AdminAuditPage
 * Type: Visual (Storybook + msw)
 * Why:  Renders the admin-audit page in isolation so visual regressions can be
...
import { AdminAuditPage as Page } from "./index";
const meta: Meta<typeof Page> = {
  title: "Pages/Admin/admin-audit",
  component: Page,
  parameters: { layout: "fullscreen" },
  decorators: [withPageProviders(["/admin/audit"])],
};
export default meta;
