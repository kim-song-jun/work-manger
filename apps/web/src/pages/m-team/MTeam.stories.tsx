/**
 * Story: pages/m-team · TeamPage
 * Type: Visual (Storybook + msw)
 * Why:  Renders the m-team page in isolation so visual regressions can be
...
import { TeamPage as Page } from "./index";
const meta: Meta<typeof Page> = {
  title: "Pages/Mobile/team",
  component: Page,
  parameters: { layout: "fullscreen" },
  decorators: [withPageProviders(["/team"])],
};
export default meta;
