/**
 * Story: pages/forgot · ForgotPasswordPage
 * Type: Visual (Storybook + msw)
 * Why:  Renders the forgot page in isolation so visual regressions can be
...
import { ForgotPasswordPage as Page } from "./index";
const meta: Meta<typeof Page> = {
  title: "Pages/Auth/forgot",
  component: Page,
  parameters: { layout: "fullscreen" },
  decorators: [withPageProviders(["/forgot"])],
};
export default meta;
