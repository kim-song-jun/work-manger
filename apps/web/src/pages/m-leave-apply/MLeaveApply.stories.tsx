/**
 * Story: pages/m-leave-apply · LeaveApplyPage
 * Type: Visual (Storybook + msw)
 * Why:  Renders the m-leave-apply page in isolation so visual regressions can be
...
import { LeaveApplyPage as Page } from "./index";
const meta: Meta<typeof Page> = {
  title: "Pages/Mobile/leave-apply",
  component: Page,
  parameters: { layout: "fullscreen" },
  decorators: [withPageProviders(["/leave-apply"])],
};
export default meta;
