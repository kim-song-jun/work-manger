/**
 * Story: pages/m-notifications · NotificationsPage
 * Type: Visual (Storybook + msw)
 * Why:  Renders the m-notifications page in isolation so visual regressions can be
...
const meta: Meta<typeof Page> = {
  ...
  decorators: [withPageProviders(["/notifications"])],
};
export default meta;
