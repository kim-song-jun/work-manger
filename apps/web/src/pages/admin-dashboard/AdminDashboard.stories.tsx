/**
 * Story: pages/admin-dashboard · AdminDashboardPage
 * Type: Visual (Storybook + msw)
 * Why:  Renders the admin-dashboard page in isolation so visual regressions can be
...
import { AdminDashboardPage as Page } from "./index";
const meta: Meta<typeof Page> = {
  title: "Pages/Admin/admin-dashboard",
  component: Page,
  parameters: { layout: "fullscreen" },
  decorators: [withPageProviders(["/admin/dashboard"])],
};
export default meta;
