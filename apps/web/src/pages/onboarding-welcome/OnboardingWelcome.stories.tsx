/**
 * Story: pages/onboarding-welcome · WelcomePage
 * Type: Visual (Storybook + msw)
 * Why:  Renders the onboarding-welcome page in isolation so visual regressions can be
...
import { WelcomePage as Page } from "./index";
const meta: Meta<typeof Page> = {
  title: "Pages/Onboarding/welcome",
  component: Page,
  parameters: { layout: "fullscreen" },
  decorators: [withPageProviders(["/onboarding/welcome"])],
};
export default meta;
