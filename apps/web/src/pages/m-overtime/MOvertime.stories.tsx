/**
 * Story: pages/m-overtime · OvertimePage
 * Type: Visual (Storybook + msw)
 * Why:  Renders the m-overtime page in isolation so visual regressions can be
...
import { OvertimePage as Page } from "./index";
const meta: Meta<typeof Page> = {
  title: "Pages/Mobile/overtime",
  component: Page,
  parameters: { layout: "fullscreen" },
  decorators: [withPageProviders(["/overtime"])],
};
export default meta;
