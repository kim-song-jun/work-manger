/**
 * Story: pages/m-customize · CustomizePage
 * Type: Visual (Storybook + msw)
 * Why:  Renders the m-customize page in isolation so visual regressions can be
...
import { CustomizePage as Page } from "./index";
const meta: Meta<typeof Page> = {
  title: "Pages/Mobile/customize",
  component: Page,
  parameters: { layout: "fullscreen" },
  decorators: [withPageProviders(["/customize"])],
};
export default meta;
