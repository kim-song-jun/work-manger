...
class AttendanceStatsApi {
  ...
  const AttendanceStatsApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [TodayStatsResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TodayStatsResponse>> attendanceStatsTodayRetrieve({ 
    ...
    final _path = r'/v1/attendance/stats/today';
    ...
    TodayStatsResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(TodayStatsResponse),
    ...
    return Response<TodayStatsResponse>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [WeeklyStatsResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<WeeklyStatsResponse>> attendanceStatsWeeklyRetrieve({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/attendance/stats/weekly';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    WeeklyStatsResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(WeeklyStatsResponse),
      ) as WeeklyStatsResponse;
    ...
    return Response<WeeklyStatsResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
