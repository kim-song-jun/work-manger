...
urlpatterns = [
    ...
    path("v1/", include("apps.audit.urls")),
    path("v1/", include("apps.compliance.urls")),
    path("v1/", include("apps.oauth.urls")),
    path("v1/", include("apps.trip.urls")),
    path("v1/", include("apps.notice.urls")),
